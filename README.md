...
2. select low option for generation, as the model was trained on ModelNet40, each obj contains approximately 10000 points. Therefore, middle and high options will generate high quality and size which is NOT suitable for the model.
3. 
```bash
cd PointNet2_API/
```
